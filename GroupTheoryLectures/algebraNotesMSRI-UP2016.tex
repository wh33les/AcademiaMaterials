...
\setbeamerfont{section in toc}{size=\fontsize{9}{10}\selectfont}
...
\usepackage{chngcntr}
\usetikzlibrary{matrix,arrows,shapes,cd}
\usepackage{comment}

% % % % % % % % % %
\AtBeginDocument{%
 \abovedisplayskip=0.3pc
 \abovedisplayshortskip=0.3pc
 \belowdisplayskip=0.3pc
 \belowdisplayshortskip=0.4pc
}
\AtBeginSection{
...
%
%ALSO MANY REMARKS AND REFERENCES THAT SEGUE INTO MORE ADVANCED ALGEBRA MATERIAL...
%}
%\end{frame}

% % % % % % % % % %
\subfile{algebraIndividualLectures/2p1basicDefinitions}
\subfile{algebraIndividualLectures/2p2basicProperties}
\subfile{algebraIndividualLectures/2p3subgroups}
\subfile{algebraIndividualLectures/2p4ordersOfGroupsAndElements}
\subfile{algebraIndividualLectures/2p5cyclicGroups}
\subfile{algebraIndividualLectures/2p6groupHomomorphisms}
\subfile{algebraIndividualLectures/2p7quotientGroups}
\subfile{algebraIndividualLectures/2p8firstIsomorphismTheorem}
\subfile{algebraIndividualLectures/2p9diagonalizationOfIntegerMatrices}
\subfile{algebraIndividualLectures/2p10FTOFinitelyGeneratedAbelianGroups}
